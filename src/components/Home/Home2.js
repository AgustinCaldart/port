        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Me gusta estar contastemente aprendiendo cosas nuevas. Por ese motivo soy Programador
              <br />
              <br />Soy un defensor de
              <i>
              ...
              <i>
                ...
                o temas relacionadas a estas{" "}
              </i>
              <br />
              <br />
              Siempre que sea posibile intento trabajar con <b className="purple">Golang</b> y
              <i>
                <b className="purple">
                  {" "}
