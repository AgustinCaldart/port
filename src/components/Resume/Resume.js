        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="Platzi"
              date="2020 - Presente"
              content={["Cursos certificados en Platzi, mayormente orientados ha Aws,Mern Stack y Go"]}
            />
            <br />
            <Resumecontent
              title="Tecnicatura en programación [UTN-FRC]"
              date="2018 - 2020"
              content={["Carrera corta en la Universidad Técnologica Nacional sede Córdoba Capital.",
